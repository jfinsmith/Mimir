...
- **Phase 1 — Seed data** ✅ — typed, validated dataset: **81 movements /
  33 families / 15 parts**, sourced from manufacturer technical sheets, Caliber
  ...
  7751, Seagull ST2528). The round-2 batch (`movements.batch2.ts`) was compiled
  from a research → adversarial-verify agent workflow. Ongoing — more get added
  over time.
